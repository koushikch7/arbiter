...
FREE_TIER_CATALOG: Dict[str, List[ModelSpec]] = {
    ...
    "cloudflare": [
        ModelSpec(
            ...
            modality="multimodal",
            notes="newest Llama 4 on CF · multimodal",
        ),
        ModelSpec(
        ...
        ModelSpec(
            ...
            notes="QwQ — best free reasoning model on Cloudflare",
        ),
        ModelSpec(
            id="@cf/qwen/qwen2.5-coder-32b-instruct", context=131_072,
            tags={"code", "reasoning"},
            rpm=300, quality=4, speed=4,
            notes="best free dedicated code model on CF",
        ),
        ModelSpec(
        ...
        ModelSpec(
            id="@cf/meta/llama-3.1-8b-instruct", context=131_072,
            tags={"fast", "balanced"},
            rpm=300, quality=2, speed=5,
        ),
        ModelSpec(
            id="@cf/meta/llama-3.2-3b-instruct", context=131_072,
            tags={"fast", "balanced"},
            rpm=300, quality=2, speed=5,
        ),
    ],
    ...
    # ── HuggingFace Inference Router (free credits) ─────────────────────
    ...
    "huggingface": [
        ...
        ModelSpec(
            id="meta-llama/Llama-3.2-1B-Instruct", context=131_072,
            tags={"fast"},
            quality=1, speed=5,
        ),
        ModelSpec(
    ...
    "pollinations": [
        ModelSpec(
            ...
            tags={"balanced", "code", "reasoning"},
            quality=3, speed=4,
            notes="GPT-OSS 20B reasoning · completely free · no key",
        ),
    ],
